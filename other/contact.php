...
<html lang="ja">
	...
	<body>
		<div id="other-container">
			...
			<!--==[お問い合わせフォーム]==-->
			<form action="other/contact_check.php" method="post" id="contact-form">
					...
					<dd class="privacy-item">
						<div class="privacy-lead">
							ご入力いただきますお客様の個人情報（住所・お名前・お電話番号・メールアドレス等）は、お問合せに対するお返事および、お返事にあたって参考事項として利用、保管させていただきます。その他、個人情報の取り扱いに関しましては、弊社
								<a id="privacy-link" href="other/privacy.php">
									「プライバシーポリシー」
								</a>
							をご覧ください。
							</div>
							...
							<label for="privacy-checkbox" id="privacy-check-label">プライバシーポリシーに同意します</label>
						</div>
					</dd>
				</dl>
				...
				<dl id="check-submit-outer">
					...
					<div id="close-contact-btn" class="local-btn">CLOSE</div>
				</dl>
			</form>
		</div>
	</body>
